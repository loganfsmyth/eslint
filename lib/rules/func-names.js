...
module.exports = {
    ...
    create(context) {
        ...
        const uninferred = context.options[0] === "uninferred";
        ...
        return {
            "FunctionExpression:exit"(node) {
                ...
                if (never) {
                    ...
                    if (!name && (uninferred ? !hasInferredName() : !isObjectOrClassMethod())) {
